...
{HTMLFormatter(bold(escape("🔹При подаче 3-х и более заявок")))}{HTMLFormatter(escape(" на таможенное оформление транспортных средств, стоимость услуги составит"))}{HTMLFormatter(bold(" 7 000 ₽."))}

{HTMLFormatter(bold("Примечания:"))}
{HTMLFormatter(escape("📌Премиум условия действует на заявки, "))}{HTMLFormatter(bold("поданные до конца ноября."))}
{HTMLFormatter(escape("📌Подать заявки необходимо "))}{HTMLFormatter(bold("единовременно"))}{HTMLFormatter(escape(", в течении одного дня."))}
