...
{HTMLFormatter(escape("*️⃣таможенное оформление автомобиля на физическое лицо — "))}{HTMLFormatter(bold("34 000 ₽"))}
{HTMLFormatter(escape("*️⃣таможенное оформление автомобиля на юридическое лицо — "))}{HTMLFormatter(bold("75 000 ₽"))}
{HTMLFormatter(italic(escape("Стоимость размещения автомобиля на складе временного хранения зависит от тарифов СВХ; от 32 000 ₽")))}
...
{HTMLFormatter(italic(escape("Стоимость размещения мотоцикла на складе временного хранения зависит от тарифов СВХ; от 15 000 ₽")))}

{HTMLFormatter(bold("Услуги по таможенному оформлению:"))}
{HTMLFormatter(escape("*️⃣таможенное оформление автомобиля — "))}{HTMLFormatter(bold("9 000 ₽"))}
...
{HTMLFormatter(escape("*️⃣установка ЭРА-ГЛОНАСС "))}{HTMLFormatter(italic(escape("(только для юрлиц)")))}{HTMLFormatter(escape(" — "))}{HTMLFormatter(bold("35 000 ₽"))}
{HTMLFormatter(escape("*️⃣устройство ЭРА-ГЛОНАСС — "))}{HTMLFormatter(bold("1 500 ₽"))}
...
{HTMLFormatter(bold("Сопровождение услуг"))}{HTMLFormatter(escape(", обеспечивая:"))}
{HTMLFormatter(escape("*️⃣прохождение технического осмотра"))}
{HTMLFormatter(escape("*️⃣процесс постановки ТС на учёт ГИБДД"))}
{HTMLFormatter(escape("*️⃣замену запчастей"))}
{HTMLFormatter(escape("*️⃣замену колес (дисков и шин)"))}
{HTMLFormatter(escape("*️⃣замена расходников: масел, фильтров, охлаждающей жидкости, свечей, аккумуляторов и т.д."))}
{HTMLFormatter(escape("*️⃣установку автосигнализации"))}
{HTMLFormatter(escape("*️⃣предоставление стоянки для транспортного средства с минимальной посуточной оплатой"))}
{HTMLFormatter(escape("*️⃣отправку по России"))}
