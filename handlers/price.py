...
{HTMLFormatter(escape("*️⃣таможенное оформление автомобиля на физическое лицо — "))}{HTMLFormatter(bold("27 000 ₽**"))}
...
{HTMLFormatter(escape("*️⃣таможенное оформление мотоцикла — "))}{HTMLFormatter(bold("22 000 ₽**"))}
...
{HTMLFormatter(escape("*️⃣таможенное оформление автомобиля на физическое лицо — "))}{HTMLFormatter(bold("7 000 ₽**"))}
...
{HTMLFormatter(italic(escape("**C учётом расширенных условий акции для бизнес-партнёров: при подаче 3-х и более заявок на таможенное оформление транспортных средств, стоимость услуги до конца сентября составит 7 000 ₽.")))}
