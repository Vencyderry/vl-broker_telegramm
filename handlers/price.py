...
{HTMLFormatter(escape("*️⃣таможенное оформление автомобиля на юридическое лицо — "))}{HTMLFormatter(bold("78 000 ₽"))}
{HTMLFormatter(italic(escape("ВАЖНО! Стоимость размещения автомобиля на складе временного хранения зависит от тарифов СВХ, сторонней организации; от 32 000 ₽ВАЖНО! Вывоз автомобиля с СВХ в лабораторию в услугу по оформлению документов СБКТС и ЭПТС не входит. Данную услугу предоставляем дополнительно, цена: 5 000 ₽")))}
...
{HTMLFormatter(escape("*️⃣таможенное оформление автомобиля — "))}{HTMLFormatter(bold("12 000 ₽"))}
